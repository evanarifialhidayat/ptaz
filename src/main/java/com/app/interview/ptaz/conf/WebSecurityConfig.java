...
import com.app.interview.ptaz.services.token.JwtRequestFilter;
...
//    	httpSecurity.csrf().disable().authorizeRequests().antMatchers(HttpMethod.DELETE, "/api/delete/**").permitAll();
...
//    	httpSecurity.csrf().disable().authorizeRequests().antMatchers(HttpMethod.POST,   "/api/update/**").permitAll();
